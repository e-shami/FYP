  ...
  return (
    <BaseRegistration
      ...
      onPress={() => {
        let error = [];
        if (
          !UserData.Validator.isValid(
            UserData.DriverSignUpData.DriversLicenseExpiry
          )
        )
          error.push("Enter a valid  License Expiry Date");
        if (driverLicense == null)
          error.push("Please upload your  License Image ");
        if (selfie == null) error.push("Please upload your selfie ");
        if (vehicleRegistration == null)
          error.push("Please upload your vehicle registration documentation ");
        if (vehiclePic == null) error.push("Please upload your vehicle Image ");
        if (error.length > 0) {
          setErrors(error);
          return;
        }
    ...
    >
      <View style={styles.container}>
        ...
        />
        <TitleSubTitle
          mainTitile={"Documents"}
          subTitle={
            "We are legally required to ask you for some documents to sign you up as driver."
          }
        />
        <View style={[styles.card, styles.shadowProp]}>
          ...
          <Pressable
            ...
            style={[styles.buttonBlack, styles.ButtonFlex]}
          >
        ...
        <View style={[styles.card, styles.shadowProp]}>
          ...
          <Pressable
            onPress={pickVehicleRegistration}
            style={[styles.buttonBlack, styles.ButtonFlex]}
          >
            <AntDesign name="upload" size={22} color="white" />
            <Text
        ...
        <View style={[styles.card, styles.shadowProp]}>
          ...
          <View style={{ alignItems: "center", borderRadius: 15, margin: 10 }}>
            {vehiclePic && (
              <Image
                source={{ uri: vehiclePic }}
                style={{ width: 200, height: 200 }}
              />
            )}
          </View>
          <Pressable
            onPress={pickVehiclePic}
            style={[styles.buttonBlack, styles.ButtonFlex]}
          >
            <AntDesign name="upload" size={22} color="white" />
            <Text
