...
export default function ChangePassword(props) {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={{fontSize:16,lineHeight:18,fontWeight:"500",fontFamily:"Poppins_400Regular",}}>Change Password</Text>
            ...
            <Pressable onPress={async () => {
                ...
                if(oldPass.trim() === newPass.trim()){
                    setErrors(["New password cannot be old password"])
                    setLoading(false)
                ...
                else if(oldPass.trim()==="" || newPass.trim()==="" || confirmPass.trim() ==="")
                {
