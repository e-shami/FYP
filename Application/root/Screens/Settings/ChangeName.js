...
export default function ChangeName(props) {
    ...
    const [Name, setName] = useState(session.SessionData.name);
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={{fontSize:16,lineHeight:18,fontWeight:"500",fontFamily:"Poppins_400Regular",}}>Change Name</Text>
            ...
            <Pressable onPress={async () => {
                ...
                await fetch(ApiUrl.changeName, {
                    ...
                    if (data.status <= 200) {
                        setLoading(false)
                        setErrors(["Name successfully changed."])
                        session.addEntry({"name":Name.trim()})
